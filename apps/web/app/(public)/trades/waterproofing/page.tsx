...
const TRADE_NAME = "Waterproofing";
...
const cityPricing = [
    { city: "Sydney", state: "NSW", shower: "$350–$650", bathroom: "$600–$1,400", balcony: "$90–$160/m²", remedial: "$150–$350/m²" },
    { city: "Melbourne", state: "VIC", shower: "$300–$600", bathroom: "$550–$1,300", balcony: "$85–$150/m²", remedial: "$140–$320/m²" },
    { city: "Brisbane", state: "QLD", shower: "$280–$580", bathroom: "$520–$1,200", balcony: "$80–$140/m²", remedial: "$130–$300/m²" },
    { city: "Perth", state: "WA", shower: "$300–$620", bathroom: "$550–$1,300", balcony: "$85–$150/m²", remedial: "$140–$320/m²" },
    { city: "Adelaide", state: "SA", shower: "$280–$560", bathroom: "$500–$1,200", balcony: "$80–$140/m²", remedial: "$130–$300/m²" },
    { city: "Canberra", state: "ACT", shower: "$320–$640", bathroom: "$580–$1,350", balcony: "$88–$158/m²", remedial: "$145–$330/m²" },
    { city: "Hobart", state: "TAS", shower: "$300–$600", bathroom: "$540–$1,250", balcony: "$84–$148/m²", remedial: "$138–$310/m²" },
    { city: "Darwin", state: "NT", shower: "$380–$720", bathroom: "$680–$1,600", balcony: "$100–$175/m²", remedial: "$160–$380/m²" },
];

const commonJobCosts = [
    ["Shower waterproofing (labour only)", "$300–$650"],
    ["Full bathroom waterproofing", "$500–$1,400"],
    ["Balcony waterproofing (per m²)", "$80–$160/m²"],
    ["Wet area membrane (polyurethane, per m²)", "$30–$65/m²"],
    ["Shower flood test (before tiling)", "Included"],
    ["Leaking shower remedial repair", "$1,500–$5,000"],
    ["Roof membrane replacement (flat roof)", "$80–$200/m²"],
    ["Underground water tank waterproofing", "$50–$120/m²"],
    ["Remedial balcony waterproofing (remove & replace)", "$3,000–$10,000"],
    ["Retaining wall waterproofing (tanking)", "$60–$130/m²"],
];

const hiringTips = [
    {
        title: "Waterproofing is mandatory — not optional",
        body: "Under the National Construction Code and Australian Standard AS 3740, all wet areas (showers, baths, laundries, balconies) must be waterproofed. This is a non-negotiable legal requirement, not a cost-saving optional step. Failure to waterproof is the leading cause of expensive structural water damage.",
        icon: BadgeCheck,
    },
    {
        title: "Always flood test before tiling begins",
        body: "After a waterproof membrane is applied and fully cured, a flood test (ponding water for 24 hours) must confirm there are no defects before tiling begins. A waterproofer who won't flood test is either cutting corners or doesn't understand the standard. Never allow tiling on an untested membrane.",
        icon: FileText,
    },
    {
        title: "Understand curing time before tiling",
        body: "Liquid polyurethane membranes need 24–48 hours to fully cure before tiling can begin. Tiling on a wet or partially cured membrane traps moisture and causes adhesive failure. Always ask your waterproofer for the product data sheet specifying minimum cure time.",
        icon: ShieldCheck,
    },
    {
        title: "Use flexible grout in corners and movement joints",
        body: "A waterproofed shower can still leak if rigid grout is used in internal corners and perimeter joints. These areas experience movement and will crack. Flexible silicone sealant must be used in all internal corners — this applies even to the best waterproofing membrane installations.",
        icon: Star,
    },
];
...
const whyTradeRefer = [
    ...
    },
    {
        ...
        body: "Use this hub to understand typical waterproofing costs for showers, bathrooms, and balconies across Australian cities so you can immediately identify underpriced or non-compliant proposals.",
    },
    {
...
export default async function WaterproofingTradeHubPage() {
    ...
    const breadcrumbJsonLd = {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Waterproofing Services Australia", item: "https://traderefer.au/trades/waterproofing" },
        ],
    };
            ...
            <div className="bg-[#1A1A1A] pt-32 pb-20 text-white">
                <div className="container mx-auto px-4">
                    <nav className="flex flex-wrap items-center gap-2 font-bold text-zinc-400 uppercase tracking-widest mb-8" style={{ fontSize: "16px" }}>
                        ...
                        <ChevronRight className="w-4 h-4" />
                        <span className="text-[#FF6600]">Waterproofing</span>
                    </nav>
                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link
                                href="/quotes?trade=Waterproofing&source=%2Ftrades%2Fwaterproofing"
                            ...
                            <Link
                                href="/businesses?category=Waterproofing"
                        ...
                        <div className="flex flex-wrap gap-6 text-white font-bold mt-8" style={{ fontSize: "16px" }}>
                            <span className="flex items-center gap-2"><DollarSign className="w-4 h-4 text-[#FF6600]" />Shower from ${cost.low}–${cost.high}{cost.unit}</span>
                            {totalBusinesses > 0 && (
                                <span className="flex items-center gap-2"><BadgeCheck className="w-4 h-4 text-[#FF6600]" />{totalBusinesses.toLocaleString()} waterproofing businesses listed</span>
                            )}
                            {statesCovered > 0 && (
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            <div className="bg-zinc-50 rounded-2xl p-5 border border-zinc-100">
                                <p className="font-black text-zinc-400 uppercase tracking-wider mb-1" style={{ fontSize: "14px" }}>Shower Waterproofing</p>
                            ...
                            <div className="bg-zinc-50 rounded-2xl p-5 border border-zinc-100">
                                <p className="font-black text-zinc-400 uppercase tracking-wider mb-1" style={{ fontSize: "14px" }}>Balcony Waterproofing</p>
                                <p className="text-3xl font-black text-zinc-900">$80–$160</p>
                                <p className="text-zinc-500" style={{ fontSize: "16px" }}>per m² (membrane system)</p>
                            </div>
                            <div className="bg-zinc-50 rounded-2xl p-5 border border-zinc-100">
                                <p className="font-black text-zinc-400 uppercase tracking-wider mb-1" style={{ fontSize: "14px" }}>Legal Requirement</p>
                                <p className="text-3xl font-black text-zinc-900">AS 3740</p>
                                <p className="text-zinc-500" style={{ fontSize: "16px" }}>mandatory in all states</p>
                            </div>
                        </div>
                            ...
                            <table className="min-w-full text-left">
                                <thead className="bg-zinc-100 text-zinc-700">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Shower</th>
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Full Bathroom</th>
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Balcony</th>
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Remedial</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {cityPricing.map((row) => (
                                        <tr key={`${row.city}-${row.state}`} className="border-t border-zinc-200 bg-white">
                                            ...
                                            <td className="px-4 py-3 text-zinc-600" style={{ fontSize: "16px" }}>{row.balcony}</td>
                                            <td className="px-4 py-3 text-zinc-600" style={{ fontSize: "16px" }}>{row.remedial}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <div className="mt-8">
                            <h3 className="font-black text-zinc-900 mb-4 font-display" style={{ fontSize: "24px" }}>Common Waterproofing Job Costs</h3>
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-8">
                        <div className="bg-white rounded-3xl border border-zinc-200 p-8">
                            <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                                ...
                                Waterproofing Services We Cover
                            </h2>
                            <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                                TradeRefer&apos;s waterproofing hub covers shower, bathroom, balcony, roof membrane, remedial, and commercial waterproofing across Australia.
                            </p>
                        ...
                        <div className="bg-white rounded-3xl border border-zinc-200 p-8">
                            <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "28px" }}>
                                ...
                                Before You Hire a Waterproofer
                            </h2>
                            <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                            ...
                            Find Waterproofers by City
                        </h2>
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Browse the major Australian cities where TradeRefer has waterproofing businesses listed, then drill into suburb-level pages from there.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                            ...
                            Waterproofing Licensing Requirements by State
                        </h2>
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        ...
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Explore adjacent trade categories that homeowners frequently research alongside waterproofing projects.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
