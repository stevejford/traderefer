...
const relatedTrades = [
    ...
    { label: "Guttering", href: "/categories#guttering" },
...
const cityPricing = [
    { city: "Sydney", state: "NSW", hourly: "$55–$110/hr", callout: "$80–$130", repair: "$300–$800", replacement: "$10,000–$22,000" },
    { city: "Melbourne", state: "VIC", hourly: "$50–$100/hr", callout: "$70–$120", repair: "$280–$750", replacement: "$9,000–$20,000" },
    { city: "Brisbane", state: "QLD", hourly: "$50–$95/hr", callout: "$65–$110", repair: "$250–$700", replacement: "$8,500–$18,000" },
    { city: "Perth", state: "WA", hourly: "$55–$105/hr", callout: "$75–$120", repair: "$280–$750", replacement: "$9,500–$20,000" },
    { city: "Adelaide", state: "SA", hourly: "$45–$90/hr", callout: "$60–$100", repair: "$250–$650", replacement: "$8,000–$17,000" },
    { city: "Canberra", state: "ACT", hourly: "$55–$110/hr", callout: "$75–$130", repair: "$300–$800", replacement: "$10,000–$22,000" },
    { city: "Hobart", state: "TAS", hourly: "$50–$95/hr", callout: "$65–$110", repair: "$270–$720", replacement: "$9,000–$19,000" },
    { city: "Darwin", state: "NT", hourly: "$60–$115/hr", callout: "$85–$140", repair: "$320–$900", replacement: "$11,000–$25,000" },
];

const commonJobCosts = [
    ["Broken tile replacement (per tile)", "$40–$120"],
    ["Ridge capping repointing (per metre)", "$25–$50"],
    ["Roof leak repair (minor)", "$300–$800"],
    ["Gutter guard installation", "$25–$60/m"],
    ["Roof restoration (clean, repoint, repaint)", "$2,500–$6,000"],
    ["Colorbond roof sheet replacement (partial)", "$1,500–$4,500"],
    ["Full tile roof replacement (3-bed home)", "$10,000–$20,000"],
    ["Full Colorbond roof replacement (3-bed home)", "$12,000–$25,000"],
    ["Skylight installation", "$1,200–$3,500"],
    ["Asbestos roof removal + replacement", "$20,000–$45,000"],
];

const hiringTips = [
    {
        title: "Confirm the correct licence type",
        body: "Roof plumbing (gutters, flashings, downpipes) requires a licensed roof plumber. Structural roofing work requires a registered builder. In several states these are separate licences — confirm which applies to your job before work starts.",
        icon: BadgeCheck,
    },
    {
        title: "Get written quotes that include all access costs",
        body: "Roofing quotes must specify scaffold, harness systems, and fall-protection costs separately. These can add $500–$2,000 to a job and are sometimes used to make initial quotes appear lower than the final invoice.",
        icon: FileText,
    },
    {
        title: "Understand your insurance claim options",
        body: "If your roof was damaged by hail or storms, your roofer should be experienced working with insurers. Get an itemised scope of works before lodging a claim — always verify the scope yourself before signing anything.",
        icon: ShieldCheck,
    },
    {
        title: "Check reviews for site safety and cleanup",
        body: "Roofing generates significant debris including broken tiles, nails, and old flashing. Confirm site cleanup is included in the quote. Review patterns around job completion, punctuality, and safety procedures are strong signals.",
        icon: Star,
    },
];
...
const whyTradeRefer = [
    ...
    },
    {
        ...
        body: "Use this hub to understand typical roofing rates before requesting quotes — so you can immediately identify overpriced or incomplete proposals.",
    },
    {
...
export default async function RoofingTradeHubPage() {
    ...
    const breadcrumbJsonLd = {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Roofing Services Australia", item: "https://traderefer.au/trades/roofing" },
        ],
    };
    ...
    const serviceJsonLd = {
        "@context": "https://schema.org",
        "@type": "Service",
        name: "Roofing Services Australia",
        serviceType: "Roofing",
            ...
            <div className="bg-[#1A1A1A] pt-32 pb-20 text-white">
                <div className="container mx-auto px-4">
                    <nav className="flex flex-wrap items-center gap-2 font-bold text-zinc-400 uppercase tracking-widest mb-8" style={{ fontSize: "16px" }}>
                        ...
                        <ChevronRight className="w-4 h-4" />
                        <span className="text-[#FF6600]">Roofing</span>
                    </nav>
                    ...
                    <div className="max-w-4xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link
                                href="/quotes?trade=Roofing&source=%2Ftrades%2Froofing"
                            ...
                            <Link
                                href="/businesses?category=Roofing"
                        ...
                        <div className="flex flex-wrap gap-6 text-white font-bold mt-8" style={{ fontSize: "16px" }}>
                            ...
                            {totalBusinesses > 0 && (
                                <span className="flex items-center gap-2"><BadgeCheck className="w-4 h-4 text-[#FF6600]" />{totalBusinesses.toLocaleString()} roofing businesses listed</span>
                            )}
                            {statesCovered > 0 && (
                ...
                <div className="max-w-6xl mx-auto space-y-16">
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                            ...
                            Roofing Cost Guide Australia
                        </h2>
                        <p className="text-zinc-500 mb-8" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Roofing costs vary by material, roof area, pitch, and access difficulty. Use these benchmarks to evaluate quotes before committing to any contractor.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                            ...
                            <div className="bg-zinc-50 rounded-2xl p-5 border border-zinc-100">
                                <p className="font-black text-zinc-400 uppercase tracking-wider mb-1" style={{ fontSize: "14px" }}>Full Roof Replacement</p>
                                <p className="text-3xl font-black text-zinc-900">$8k–$25k</p>
                                <p className="text-zinc-500" style={{ fontSize: "16px" }}>3-bedroom home</p>
                            </div>
                            <div className="bg-zinc-50 rounded-2xl p-5 border border-zinc-100">
                            ...
                            <table className="min-w-full text-left">
                                <thead className="bg-zinc-100 text-zinc-700">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Leak Repair</th>
                                        <th className="px-4 py-3 font-black" style={{ fontSize: "14px" }}>Full Replacement</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {cityPricing.map((row) => (
                                        <tr key={`${row.city}-${row.state}`} className="border-t border-zinc-200 bg-white">
                                            ...
                                            <td className="px-4 py-3 text-zinc-600" style={{ fontSize: "16px" }}>{row.repair}</td>
                                            <td className="px-4 py-3 text-zinc-600" style={{ fontSize: "16px" }}>{row.replacement}</td>
                                        </tr>
                                    ))}
                                </tbody>
                            </table>
                        ...
                        <div className="mt-8">
                            <h3 className="font-black text-zinc-900 mb-4 font-display" style={{ fontSize: "24px" }}>Common Roofing Job Costs</h3>
                    ...
                    <section className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-8">
                        <div className="bg-white rounded-3xl border border-zinc-200 p-8">
                            ...
                            <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                                TradeRefer's roofing hub covers everything from urgent leak repairs through to full roof replacements, restorations, and skylight installations.
                            </p>
                        ...
                        <div className="bg-white rounded-3xl border border-zinc-200 p-8">
                            ...
                            <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                                Use these checks to avoid unlicensed work, inflated storm-damage quotes, and safety risks on your roof.
                            </p>
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                            ...
                            Find Roofing Businesses by City
                        </h2>
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Start with the major cities where TradeRefer already has roofing businesses listed, then drill into suburb-level pages from there.
                        </p>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        <h2 className="font-black text-[#1A1A1A] mb-2 flex items-center gap-2 font-display" style={{ fontSize: "32px" }}>
                            ...
                            Roofing Licensing Requirements by State
                        </h2>
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Roofing licensing varies across Australia — roof plumbing and structural work are separately regulated in most states and territories.
                        </p>
                    ...
                    <section className="bg-white rounded-3xl border border-zinc-200 p-8 md:p-10">
                        ...
                        <p className="text-zinc-500 mb-6" style={{ fontSize: "18px", lineHeight: 1.7 }}>
                            Continue exploring adjacent trade categories that homeowners often research alongside roofing work.
                        </p>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
